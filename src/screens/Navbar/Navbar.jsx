...
export default function Navbar({tabIndex, dividerColor = "white"}) {
    ...
    return (
        <Box>
            <Box sx={{borderBottom: 1, borderColor: dividerColor, py: {xs: 1, sm: 2, md: 3}}}>
                <Stack direction="row" justifyContent="space-between">
                    ...
                    >
                        <CardMedia
                            image={require('../../assets/images/ruberah@3x.png')}
                        />
                    </Box>
                </Stack>
            </Box>
